...
watchEffect(() => {
    ...
    if (route.fullPath === `/category/sub/${id}`) {
        category.getSubFilter(id as string)
    }
})
</script>
    ...
    <div class="sub-category">
        <div class="container">
            ...
            <XtxBread>
                ...
                <XtxBreadItem :to="`/category/${subCategory.id}`">{{ subCategory.parentName }}
                </XtxBreadItem>
            ...
            <div class="sub-filter">
                <div class="item">
                    ...
                    <div class="body">
                        ...
                        <a href="javascript:;" v-for="item in subCategory.brands" :key="item.id">
                            {{ item.name }}
                        </a>
                    </div>
                </div>
