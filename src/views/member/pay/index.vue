...
import { OrderPayInfo } from '@/types/cart'
...
// 第三方支付的跳转地址与回跳地址
// 回调地址 encodeURIComponent 编译成code语言 防止浏览器错误当成地址
const redirectUrl = encodeURIComponent('http://www.corho.com:8080/#/pay/callback')
// 支付地址 后端给的字段 ${baseURL}pay/aliPay?orderId 支付地址  ${route.query.id}&redirect=${redirectUrl}`回跳地址
    ...
    <div class="xtx-pay-page">
        <div class="container">
            ...
            <div class="pay-info">
                ...
                <div class="amount">
                    <span>应付总额：</span>
                    <span>¥{{ order.totalMoney && (order.totalMoney).toFixed(2) }}</span>
                </div>
            </div>
            <!-- 付款方式 -->
            <div class="pay-type">
